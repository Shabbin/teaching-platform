  ...
  />
          ...
          <nav className="flex gap-8">
            <Link
              ...
              className="text-sm font-semibold text-gray-700 hover:text-indigo-600 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded"
            >
              Become a Tutor
            </Link>
            <Link
      ...
      <section className="flex flex-col items-center justify-center text-center py-28 px-6 max-w-4xl mx-auto">
        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight text-indigo-700 drop-shadow-md">
          Find the Perfect Tutor for You
        </h1>
        <p className="text-lg md:text-2xl mb-10 max-w-xl text-gray-700">
          Learn any subject, anywhere — online or in-person, with verified and passionate teachers.
        </p>
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
          <Link
            href="/teachers"
            className="inline-block bg-indigo-600 text-white text-lg font-semibold px-8 py-4 rounded-lg shadow-lg hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-indigo-300 transition"
          >
            Find a Teacher
          </Link>
          <Link
            href="/register/teacher"
            className="inline-block bg-white border-2 border-indigo-600 text-indigo-600 text-lg font-semibold px-8 py-4 rounded-lg shadow-md hover:bg-indigo-50 focus:outline-none focus:ring-4 focus:ring-indigo-300 transition"
          >
            Become a Teacher
          </Link>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-700 leading-relaxed">
                All teachers go through a thorough approval process to ensure quality and expertise.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300">
              <h3 className="text-2xl font-semibold mb-4 text-indigo-600">
              ...
              <p className="text-gray-700 leading-relaxed">
                Choose your tutor, schedule, and learning style — online or offline — all tailored to your needs.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300">
              <h3 className="text-2xl font-semibold mb-4 text-indigo-600">
              ...
              <p className="text-gray-700 leading-relaxed">
                Need help with a specific topic? Send a request and get fast, personalized tutoring support.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Testimonials Section with Realistic Avatars */}
      <section className="py-20 px-6 max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold mb-14 text-indigo-700 text-center tracking-wide">
          What Our Students Say
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <blockquote className="bg-white rounded-xl shadow-md p-8 italic text-gray-800 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center text-center">
            <img
              ...
              loading="lazy"
            />
            “This platform helped me find an amazing tutor who made learning so much easier and fun!”
            <footer className="mt-6 font-semibold text-indigo-600">— Sarah K.</footer>
          </blockquote>
          ...
          <blockquote className="bg-white rounded-xl shadow-md p-8 italic text-gray-800 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center text-center">
            <img
              ...
              loading="lazy"
            />
            “Flexible scheduling and great teachers. I highly recommend it to anyone who wants personalized learning.”
            <footer className="mt-6 font-semibold text-indigo-600">— Ahmed R.</footer>
          </blockquote>
          ...
          <blockquote className="bg-white rounded-xl shadow-md p-8 italic text-gray-800 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center text-center">
            <img
              ...
              loading="lazy"
            />
            “Quick help whenever I needed it. The request-based tutoring saved my grades!”
            <footer className="mt-6 font-semibold text-indigo-600">— Priya M.</footer>
          </blockquote>
        </div>
      </section>
      ...
      <section className="bg-indigo-600 py-16 px-6 text-center rounded-t-3xl shadow-lg mx-6 md:mx-20 mb-12 text-white">
        ...
        <p className="mb-8 max-w-xl mx-auto text-lg opacity-90">
          Join thousands of learners and teachers making education accessible and flexible.
        </p>
        <Link
          href="/register"
      ...
      <footer className="bg-white border-t border-indigo-100 py-10 mt-auto">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            ...
            <a href="#" aria-label="Instagram" className="hover:text-indigo-600 transition">
              <svg
                className="w-6 h-6"
                fill="currentColor"
                viewBox="0 0 24 24"
