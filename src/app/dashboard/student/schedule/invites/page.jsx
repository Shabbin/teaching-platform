...
function RightSidebar({ teachers = [] }) {
  ...
  return (
    <aside className="w-[320px] bg-white/40 backdrop-blur-md md:backdrop-blur-3xl p-8 border-l border-white/50 flex-shrink-0 min-h-screen hidden md:block relative z-20">
      <div className="flex flex-col h-full space-y-8">
        <div>
          ...
          <div className="p-5 rounded-[1.5rem] bg-white/60 backdrop-blur-md md:backdrop-blur-xl border border-white shadow-lg">
        ...
        <div>
          ...
          {todayItems.length === 0 ? <p className="text-[10px] font-black uppercase text-slate-400 text-center py-8">Free Schedule</p> : (
            <div className="space-y-3">
              {todayItems.map(it => (
                <div key={it.id} className="p-4 rounded-2xl bg-white/60 backdrop-blur-md md:backdrop-blur-xl border border-white shadow-lg">
          ...
          <div className="p-4 md:p-12 max-w-5xl mx-auto space-y-16">
            <section>
              ...
              {loading ? (
                ...
                <div className="p-20 text-center rounded-[3rem] bg-white/40 backdrop-blur-md md:backdrop-blur-3xl border border-white shadow-lg md:shadow-2xl">
                ...
                <div className="space-y-6">
                  {pending.map((inv, idx) => (
                    <motion.div
                      ...
                      className="group relative bg-white/70 backdrop-blur-md md:backdrop-blur-3xl rounded-[3rem] border border-white p-8 shadow-lg md:shadow-xl shadow-slate-200/40 hover:shadow-emerald-500/10 transition-all duration-500"
                    >
